...
export default function Footer() {
  return (
    <div className="flex flex-col self-stretch pt-14 mt-24 w-full bg-teal-800 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-wrap gap-5 justify-between items-start self-center w-full max-w-[1621px] max-md:max-w-full">
        ...
        <nav className="flex flex-col items-start mt-1.5 text-base text-zinc-300">
          ...
          <a href="#" className="self-stretch mt-1.5 leading-loose max-md:mr-1">
            Monitor Progress
          </a>
      ...
      <div className="flex flex-col justify-center items-center px-16 py-3 mt-12 w-full text-base leading-loose text-white bg-white max-md:px-5 max-md:mt-10 max-md:max-w-full">
