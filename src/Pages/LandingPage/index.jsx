...
const stats = [
  ...
  { number: "75%", label: "Percentage of success" },
  { number: "35", label: "Numbers of questions" },
  { number: "25+", label: "Number of experts" },
...
function LandingPage() {
  ...
  return (
    <>
      <Header />
      <div className="px-6" id="main">
        <div
          className="mt-20 w-full px-10 max-md:mt-10 max-md:max-w-full"
          id="HomePage"
        >
        ...
        <div className="px-20 py-16 bg-teal-50 my-20 ">
          <h2 className=" text-4xl text-center font-semibold leading-none text-black max-md:mt-10">
            Our Success
          </h2>

          <div className="flex flex-wrap gap-5 justify-between items-center  py-1 mt-12 w-full font-medium ">
        ...
        <div className="mt-24 ml-2.5 w-full mx-auto">
